...
class MyColor
{
  ...
  final static float minR = 2;
  final static float maxR = 252;
  final static float minG = 252;
  final static float maxG = 2;
  final static float minB = 198;
  final static float maxB = 139;
...
class SeaWeed
{
  ...
  final static float maxWidth = 100;//max width of the base line
  final static float minWidth = 11;//min width of the base line
  final static float FLOTATION = -6;//flotation constant
